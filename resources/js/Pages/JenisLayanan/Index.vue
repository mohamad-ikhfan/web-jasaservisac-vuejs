...
export default defineComponent({
    ...
    methods: {
        addData() {
            this.$inertia.get(route("jenis-layanan.create"));
        },

        deleteData(id) {
            if (!confirm("Yakin Hapus data ini?")) return;
            this.$inertia.delete(route("jenis-layanan.destroy", { id }));
        },

        searchData: _.throttle(function () {
            this.$inertia.replace(
                this.route("jenis-layanan.index", { search: this.search })
            );
        }),

        clearSearch: _.throttle(function () {
            this.$inertia.replace(
                this.route("jenis-layanan.index", { search: "" })
            );
            this.search = "";
        }),
...
<template>
    <app-layout title="Jenis Layanan">
        ...
        <div class="flex justify-center">
            <div class="block rounded-lg shadow-lg bg-white min-w-full">
                            ...
                            >
                                <div class="overflow-x-auto overflow-y-hidden">
                                    <table class="min-w-full">
                                        ...
                                        <tbody>
                                            <template v-if="jenis.data.length">
                                                <tr
                ...
                <div
                    ...
                    v-show="jenis.links.length > 3"
                >
                    <Pagination :links="jenis.links"></Pagination>
                </div>
            </div>
        </div>
    </app-layout>
