...
export default defineComponent({
    ...
    data() {
        return {
            form: this.$inertia.form({
                kategori: this.jenis.id_kategori,
                nama_layanan: this.jenis.nama_layanan,
                harga: this.jenis.harga,
            }),
        };
    },
    ...
    methods: {
        submit(id) {
            this.form.put(route("jenis-layanan.update", { id }));
        },

        backPage() {
            this.$inertia.get(route("jenis-layanan.index"));
        },
    },
});
</script>
    ...
    <app-layout title="Kategori Layanan">
        <div class="flex justify-center">
            <div class="block rounded-lg shadow-lg bg-white min-w-full">
                ...
                <form @submit.prevent="submit(jenis.id)">
                    <div class="p-6">
                        ...
                        <div class="form-group mb-6">
                            ...
                            <div
                                class="text-red-700 text-sm mt-1"
                                v-show="form.errors.nama_layanan"
                            >
                                {{ form.errors.nama_layanan }}
                            </div>
                        </div>
