...
export default defineComponent({
    ...
    methods: {
        addData() {
            this.$inertia.get(route("akses-user.create"));
        },

        searchData: _.throttle(function () {
            this.$inertia.replace(
                this.route("akses-user.index", { search: this.search })
            );
        }),

        clearSearch: _.throttle(function () {
            this.$inertia.replace(
                this.route("akses-user.index", { search: "" })
            );
            this.search = "";
        }),
        ...
        resetPassword(id) {
            ...
            this.$inertia.post(route("akses-user.reset-password", { id }));
        },
    },
});
</script>
                                        ...
                                        <tbody>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <td
                                                        class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap lowercase space-x-3"
                                                    >
                                                        {{ row.email }}
                                                        <span
                                                            v-if="
                                                                ...
                                                                null
                                                            "
                                                            class="text-xs inline-block py-1 px-1.5 leading-none text-center whitespace-nowrap align-baseline font-semibold bg-yellow-500 text-white rounded-full"
                                                            >email belum
                                                            verfikasi</span
                                                        >
                                                        <span
                                                            v-else
                                                            class="text-xs inline-block py-1 px-1.5 leading-none text-center whitespace-nowrap align-baseline font-semibold bg-green-500 text-white rounded-full"
                                                            >sudah
                                                            verfikasi</span
                                                        >
                                                    </td>
                                                    ...
                                                    >
                                                        <button
                                                            type="button"
                                                            class="text-sm inline-block p-1.5 leading-none bg-yellow-500 text-white rounded mx-1"
