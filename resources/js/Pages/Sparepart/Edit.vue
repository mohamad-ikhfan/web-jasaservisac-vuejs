...
export default defineComponent({
    ...
    data() {
        return {
            ...
            form: this.$inertia.form({
                ...
                harga: this.sparepart.harga,
                keterangan: this.sparepart.keterangan,
            }),
        };
    },
    ...
    methods: {
        submit(id) {
            this.form.put(route("sparepart.update", { id }));
        },
...
<template>
    <app-layout title="Ubah Sparepart">
        <div class="flex justify-center">
            <div class="block rounded-lg shadow-lg bg-white min-w-full">
                ...
                <form
                    @submit.prevent="submit(sparepart.id)"
