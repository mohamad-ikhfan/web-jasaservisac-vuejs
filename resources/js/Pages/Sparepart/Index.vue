...
export default defineComponent({
    ...
    methods: {
        addData() {
            this.$inertia.get(route("sparepart.create"));
        },

        deleteData(id) {
            if (!confirm("Yakin Hapus data ini?")) return;
            this.$inertia.delete(route("sparepart.destroy", { id }));
        },

        searchData: _.throttle(function () {
            this.$inertia.replace(
                this.route("sparepart.index", { search: this.search })
            );
        }),

        clearSearch: _.throttle(function () {
            this.$inertia.replace(
                this.route("sparepart.index", { search: "" })
            );
            this.search = "";
        }),
        ...
        <div class="flex justify-center">
            <div class="block rounded-lg shadow-lg bg-white min-w-full">
                <div class="py-3 px-6 border-b border-gray-300">
                    <h5 class="text-gray-900 text-xl font-medium">Sparepart</h5>
                </div>
                ...
                <div
                    ...
                    v-show="sparepart.links.length > 3"
                >
                    <Pagination :links="sparepart.links"></Pagination>
                </div>
            </div>
        </div>
    </app-layout>
