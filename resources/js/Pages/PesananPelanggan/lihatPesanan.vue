...
export default defineComponent({
  ...
  methods: {
    ...
    terimaPesanan() {
      this.$inertia.post(
        route("pesanan-pelanggan.terima-pesanan", this.pesanan.no_pesanan)
      );
    },

    tolakPesanan() {
      this.$inertia.post(
        route("pesanan-pelanggan.tolak-pesanan", this.pesanan.no_pesanan)
      );
    },
  },
});
    ...
    <div class="flex justify-center">
      <div class="block rounded-lg shadow-lg bg-white min-w-full">
        <div class="py-3 px-6 border-b border-gray-300">
          <h5 class="text-gray-900 text-xl font-medium">Lihat Pesanan</h5>
        </div>
        ...
        <div class="p-6 overflow-hidden">
          <div class="w-full">
              ...
              <div>
                <h6 class="font-bold">
                  ...
                  <span class="text-sm font-medium uppercase">
                    {{ formatDate(orderDate(pesanan.no_pesanan)) }}</span
                  >
                </h6>
                <h6 class="font-bold">
                  Jadwal Pengerjaan :
            ...
            <div class="py-5">
              <div class="border-b border-gray-200 shadow overflow-y-auto">
                <table class="w-full border text-left">
                  <thead class="bg-gray-50 text-center">
                    <tr class="border">
                      <th class="px-4 py-2 text-gray-500">#</th>
                      <th class="px-4 py-2 text-gray-500" colspan="3">
                        Keterangan
                      </th>
                      <th class="px-4 py-2 text-gray-500 text-left">Harga</th>
                    </tr>
                  </thead>
                  <tbody class="bg-white">
                    ...
                    <tr class="whitespace-nowrap border font-bold">
                      <th
                        class="px-4 py-2 text-gray-500 bg-gray-50 text-center"
                      >
                        #
                      ...
                      <td class="p-2">
                        <div class="text-gray-900 capitalize bg-gray-50">
                          {{ "Rp." + formatNumber(pesanan.total_tagihan) }}
                        </div>
                      </td>
                    </tr>
                  </tbody>
            ...
            <div class="flex justify-between p-4">
              <div>
                ...
                <ul class="text-xs list-disc list-inside capitalize">
