...
export default defineComponent({
    ...
    data() {
        return {
            form: this.$inertia.form({
                sparepart: this.stok_sparepart.id_sparepart,
                jumlah: this.stok_sparepart.jumlah,
            }),
        };
    },
    ...
    methods: {
        submit(id) {
            this.form.put(route("stok-sparepart.update", { id }));
        },
...
<template>
    <app-layout title="Ubah Stok Sparepart">
        <div class="flex justify-center">
            <div class="block rounded-lg shadow-lg bg-white min-w-full">
                ...
                <form @submit.prevent="submit(stok_sparepart.id)">
                    <div class="p-6">
