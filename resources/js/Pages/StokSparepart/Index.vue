...
export default defineComponent({
    ...
    methods: {
        ...
        clearSearch: _.throttle(function () {
            this.$inertia.replace(
                this.route("stok-sparepart.index", { search: "" })
            );
            this.search = "";
        }),
    },
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <Link
                                                            class="text-sm inline-block p-1.5 leading-none bg-red-500 text-white rounded mx-1"
                                                            title="Hapus"
                                                            @click.prevent="
                                                                deleteData(
                                                                    row.id
