          ...
          <div class="p-6 px-10">
            <div class="form-group mb-6">
              ...
              >
                <input
                  ...
                  @input="(checked) => (form.harga_layanan = lyn['harga'])"
                />
                <label
            ...
            <div class="form-group mb-6">
              ...
              <input
                ...
                id="unit"
              />
              <div class="text-red-700 text-sm mt-1" v-show="form.errors.unit">
                {{ form.errors.unit }}
              </div>
            </div>

            <div class="form-group mb-6">
              <label for="keluhan" class="form-label block mb-2 text-gray-700"
            ...
            <div class="form-group mb-6">
              ...
              >
                <input
                  ...
                  @input="
                    (checked) => (form.biaya_properti = pr['biaya_properti'])
                  "
                />
                <label
                  class="form-check-label capitalize ml-1"
                  ...
                  >{{ pr["properti"]
                    ...
                    pr["biaya_properti"] > 1
                      ? " (+Rp." + formatNumber(pr["biaya_properti"]) + ")"
                      : ""
                  }}</label
                >
              </div>
            ...
            <div class="form-group mb-6">
              <div class="form-label block mb-2 text-gray-700">
                ...
                <Button class="ml-2" @click.prevent="$emit((all_alamat = true))"
                  ><span
                    class="
                      text-xs
                      inline-block
              ...
              <div
                ...
                :key="almt"
                v-show="all_alamat ? true : form.alamat == almt['id']"
              >
                <input
                  class="hidden"
                  :id="'alamat' + almt['id']"
                ...
                >
                  <span class="text-xs font-semibold uppercase font-bold">{{
                    almt["label"]
                  }}</span>
          ...
          <div class="py-3 px-6 border-t border-gray-300 text-gray-600">
            ...
            >
              ...
              <span>{{
                "Rp. " +
                formatNumber(
                  form.unit * form.harga_layanan + form.biaya_properti
                )
              }}</span>
            </div>
            <div class="my-3">
