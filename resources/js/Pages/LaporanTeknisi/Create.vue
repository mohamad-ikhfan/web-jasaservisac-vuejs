...
export default defineComponent({
    ...
    methods: {
        getPesanan() {
            if (this.no_pesanan == "") {
                this.$inertia.replace(route("laporan-teknisi.create"), {
                    preserveScroll: true,
                });
            } else {
                this.$inertia.replace(
                    route("laporan-teknisi.create", {
                        pesanan: this.no_pesanan,
                    }),
                    {
                        preserveScroll: true,
                    }
                                ...
                                <div class="form-group mb-6">
                                    ...
                                    <div class="mt-4 text-right">
                                        <button
                                            ...
                                            class="px-6 py-2.5 bg-gray-300 text-blue-600 text-sm font-semibold rounded-lg"
                                        >
                                            Cari Pesanan
                                        </button>
                                    </div>
