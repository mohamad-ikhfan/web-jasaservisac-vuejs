...
<template>
    <app-layout title="Home">
        <section class="mb-32 text-gray-800">
            ...
            >
                <div
                    class="p-0 py-12 lg:mx-2"
                    v-for="row in layanan"
                    :key="row"
                >
                    <div class="block rounded-lg shadow-lg bg-white h-full">
                        <div class="p-6 border-b border-gray-300 text-center">
                            ...
                            <Link
                                ...
                                class="inline-block px-6 py-2.5 bg-gray-300 text-slate-900 font-medium text-xs leading-tight uppercase rounded hover:text-gray-50 hover:bg-blue-500 transition duration-150 ease-in-out w-full"
                            >
                                pesan sekarang
                            </Link>
                        </div>
