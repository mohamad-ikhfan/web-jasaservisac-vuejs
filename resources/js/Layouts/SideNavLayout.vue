    ...
    >
      <div class="pt-4 pb-2 px-6">
        ...
        >
          <div class="flex items-center">
            ...
            <div class="grow ml-3">
              <p class="text-sm font-semibold text-blue-600 capitalize">
      ...
      <ul class="relative px-1">
        ...
        >
          ...
          >
            <span class="mr-3"
              ><font-awesome-icon icon="fa-brands fa-servicestack"
            /></span>
        ...
        <li class="relative" id="sidenavPesanan">
          ...
          >
            <span class="mr-3"
              ><font-awesome-icon icon="fa-solid fa-arrow-down-up-across-line"
            /></span>
          ...
          <ul
            ...
            data-bs-parent="#sidenavSecExample"
            :class="route().current('pesanan-pelanggan.*') ? 'show' : ''"
          >
            <li class="relative">
              <Link
                class="
                ...
                data-mdb-ripple-color="primary"
                :class="
                  route().current('pesanan-pelanggan.daftar-pesanan')
                    ? 'ripple-surface-primary bg-blue-100 text-blue-700'
                    : 'text-gray-700'
                "
                :href="route('pesanan-pelanggan.daftar-pesanan')"
              >
                <span class="mr-3"
                  ><font-awesome-icon icon="fa-solid fa-rectangle-list"
                /></span>
            ...
            <li class="relative">
              <Link
                ...
                data-mdb-ripple-color="primary"
                :class="
                  route().current('pesanan-pelanggan.pesanan-masuk')
                    ? 'ripple-surface-primary bg-blue-100 text-blue-700'
                    : 'text-gray-700'
                "
        ...
        <li class="relative" id="sidenavLaporan">
          ...
          <ul
            ...
            data-bs-parent="#sidenavSecExample"
            :class="route().current('laporan-teknisi.*') ? 'show' : ''"
          >
            <li class="relative">
              <Link
                class="
            ...
            <li
              class="relative"
              v-show="$page.props.akses.teknisi || $page.props.akses.pemilik"
            >
              <Link
                class="
                  flex
