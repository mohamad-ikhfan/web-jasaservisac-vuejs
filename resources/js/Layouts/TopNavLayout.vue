...
<template>
    <div>
        ...
        <div class="flex flex-col h-screen">
            <nav
                class="sticky top-0 z-50 w-full flex flex-wrap items-center justify-between p-5 bg-gray-100 text-gray-500 hover:text-gray-700 focus:text-gray-700 shadow-lg navbar navbar-expand-lg navbar-light"
            >
                <div
                ...
                >
                    ...
                    >
                        ...
                        <div class="dropdown relative ml-5">
                            ...
                            >
                                ...
                                <span
                                    class="capitalize ml-2 hover:text-blue-600"
                    ...
                    <div class="flex items-center relative" v-else>
                        <Link
                            ...
                            :class="
                                route().current('login') ? 'text-blue-600' : ''
                            "
                            :href="route('login')"
                        >
                            <span
